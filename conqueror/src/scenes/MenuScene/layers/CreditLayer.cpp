...
void CreditLayer::OnAttach()
{
	...
	special_thanks = new GameObject("credit12", Transform(glm::vec2(0.0f, -24.0f - yOffset), glm::vec2(0.5f, 0.5f)));
	special_thanks->AddComponent(new FontRenderer(color, "Special Thanks:", ui_font_family));
	...
	rebstock = new GameObject("credit16", Transform(glm::vec2(0.0f, -28.0f - yOffset), glm::vec2(0.7f, 0.7f)));
