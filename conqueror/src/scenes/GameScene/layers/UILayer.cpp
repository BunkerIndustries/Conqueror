...
void UILayer::ActivateSoldierUI() {
	...
	Button* call_medic_button = new Button(ui_call_medic_button_color, ui_medic_button_transform, Type::Rectangle, Medic::SendMedic, "ui_call_medic_button");
...
void UILayer::ActivateMedicBuildlingUI() {
	building_background = new PictureBox(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), Transform(ui_building_position, ui_building_background_size), DataPool::GetTexture("UI/box_2.png"), Type::Rectangle);
...
void UILayer::ActivateEngineerBuildingUI() {
	building_background = new PictureBox(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), Transform(ui_building_position, ui_building_background_size), DataPool::GetTexture("UI/box_1.png"), Type::Rectangle);
...
void UILayer::ActivateSupplyMenuUI() {
	...
	supply_menu_background = new PictureBox(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), Transform(glm::vec2(0.0f, 0.0f), ui_supply_menu_background_size), DataPool::GetTexture("UI/big_box.png"), Type::Rectangle);
	...
	PictureBox* left_option = new PictureBox(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), Transform(ui_left_choice_field_position, ui_choice_field_size), DataPool::GetTexture("UI/box_1.png"), Type::Rectangle);
	...
	Button* left_option_button = new Button(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), ui_choice_field_button_transform, Type::Rectangle, Supply::TakeLeftOption, "ui_upply_menu_left_choice_button");
	PictureBox* button1_pb = new PictureBox(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), Transform(glm::vec2(0.0f, 0.0f), glm::vec2(1.0f, 1.0f)), DataPool::GetTexture("UI/box_small.png"), Type::Rectangle);
	left_option_button->AddChildObject(button1_pb);
	left_option->AddChildObject(left_option_button);

	PictureBox* right_option = new PictureBox(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), Transform(ui_right_choice_field_position, ui_choice_field_size), DataPool::GetTexture("UI/box_1.png"), Type::Rectangle);
	...
	Button* right_option_button = new Button(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), ui_choice_field_button_transform, Type::Rectangle, Supply::TakeRightOption, "ui_upply_menu_right_choice_button");
	PictureBox* button2_pb = new PictureBox(glm::vec4(1.0f, 1.0f, 1.0f, 1.0f), Transform(glm::vec2(0.0f, 0.0f), glm::vec2(1.0f, 1.0f)), DataPool::GetTexture("UI/box_small.png"), Type::Rectangle);
