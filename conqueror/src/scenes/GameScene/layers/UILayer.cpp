...
void UILayer::ActivateSoldierUI() {
	...
	Label* name = new Label("Soldier: ", ui_font_color, ui_header_name_transform, DataPool::GetFont("mononoki.ttf"), "ui_character_name");
...
void UILayer::ActivateMedicUI() {
	...
	Label* name = new Label("Medic: ", ui_font_color, ui_header_name_transform, DataPool::GetFont("mononoki.ttf"), "ui_character_name");
	// add picturebox child object
	header->AddChildObject(name);
...
void UILayer::ActivateEngineerUI() {
	...
	Panel* header = new Panel(ui_header_color, ui_header_transform, Type::Rectangle, "ui_character_header");
	// picturebox with picture of medic
	Label* name = new Label("Engineer: ", ui_font_color, ui_header_name_transform, DataPool::GetFont("mononoki.ttf"), "ui_character_name");
	// add picturebox child object
	header->AddChildObject(name);
...
void UILayer::ActivateMedicBuildlingUI() {
	...
	Label* name = new Label("Medic-building: ", ui_font_color, ui_header_name_transform, DataPool::GetFont("mononoki.ttf"), "ui_buildling_name");
	// add picturebox child object
	header->AddChildObject(name);
...
void UILayer::ActivateEngineerBuildingUI() {
	...
	Panel* header = new Panel(ui_header_color, ui_header_transform, Type::Rectangle, "ui_building_header");
	// picturebox with picture of medic-bulding
	Label* name = new Label("Engineer-building: ", ui_font_color, ui_header_name_transform, DataPool::GetFont("mononoki.ttf"), "ui_buildling_name");
...
void UILayer::ActivateSupplyMenuUI() {
	...
	Label* text = new Label("You completed a wave!", ui_font_color, ui_supply_menu_text_transform, DataPool::GetFont("mononoki.ttf"), "ui_supply_menu_text");
	...
	Label* left_option_text = new Label("Soldiers", ui_font_color, ui_choice_field_text_transform, DataPool::GetFont("mononoki.ttf"), "ui_supply_menu_left_choice_text");
	left_option->AddChildObject(left_option_text);
	Label* left_option_count = new Label(std::to_string(Supply::CreateLeftOption()) + "x", ui_font_color, ui_choice_field_count_transform, DataPool::GetFont("mononoki.ttf"), "ui_supply_menu_left_choice_count");
